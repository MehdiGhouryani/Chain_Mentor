...
async def send_invoice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
    "**دسترسی ویژه به کانال‌های VIP حرفه‌ای**\n\n"
    "✨ *چرا باید به VIP بپیوندید؟*\n\n"
    "1️⃣ **ارزهای نوظهور با تحلیل‌های دقیق:**\n"
    "فرصتی استثنایی برای شناسایی بهترین سرمایه‌گذاری‌ها با راهنمایی‌های گام‌به‌گام.\n\n"
    "2️⃣ **اطلاعات آلفا با کمتر از یک ساعت عمر:**\n"
    "دسترسی به سریع‌ترین اطلاعات برای پیشی گرفتن از دیگران در بازار.\n\n"
    "💎 *این خدمات برای چه کسانی مناسب است؟*\n"
    "- افرادی که آموزش‌های لازم را دیده‌اند و آماده‌اند از تجربه خود استفاده کنند.\n"
    "- کسانی که به دنبال سرمایه‌گذاری هوشمندانه و کنترل احساسات هستند.\n\n"
    "🔑 **VIP فقط برای افراد حرفه‌ای است!**\n"
    "اگر آماده‌اید تا از فرصت‌های طلایی برای کسب سودهای پایدار استفاده کنید، اکنون بهترین زمان برای اقدام است. 🚀\n\n"
    "🌟 **به VIP بپیوندید و یک قدم جلوتر از بازار باشید!**"
)
